...
$(document).ready(function () {
    ...
    // Initialisation
    setupNomAutocomplete('#NcontactInput3', '#contactSuggestions3', '/../controllers/predict_PHP/recup_nom_contact.php');
    setupNomAutocomplete('#NcontactInput_fiche', '#contactSuggestions_fiche', '/../controllers/predict_PHP/recup_nom_contact.php');
});
