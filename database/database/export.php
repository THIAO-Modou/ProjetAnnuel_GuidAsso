...
// Récupérer liste des utilisateurs sélectionnés
...
// Filtre par utilisateur si admin et si liste non vide
if ($idFonction == 2 && !empty($selectedUsers)) {
...
// Bind des utilisateurs
if ($idFonction == 2 && !empty($selectedUsers)) {
    foreach ($selectedUsers as $index => $mail) {
        $stmt->bindValue($index+1, $mail, PDO::PARAM_STR);
    }
}

// Bind des mail pour personaliser l'export
if ($idFonction == 1) {
