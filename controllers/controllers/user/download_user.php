...
$filePath = realpath(__DIR__ . '/../controllers/questionnaire/pjbn/' . $fileName); // 🔹 Assure-toi que le chemin est correct

// Vérifier si le fichier existe et est bien dans le bon dossier
if (!$filePath || !file_exists($filePath) || strpos($filePath, realpath(__DIR__ . '/../controllers/questionnaire/pjbn/')) !== 0) {
...
// Téléchargement forcé (Garde ce qui marchait !)
